...
//        });
        ...
        Schema::create('use_case_template_question_responses', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('use_case_template_question_responses');
...
//        Schema::table('projects', function (Blueprint $table) {
//            $table->string('useCases')->default('no')->change();
//            $table->decimal('use_case_rfp', 5)->nullable()->default(null)->change();
//            $table->decimal('use_case_solution_fit', 5)->nullable()->default(null)->change();
//            $table->decimal('use_case_usability', 5)->nullable()->default(null)->change();
//            $table->decimal('use_case_performance', 5)->nullable()->default(null)->change();
//            $table->decimal('use_case_look_feel', 5)->nullable()->default(null)->change();
//            $table->decimal('use_case_others', 5)->nullable()->default(null)->change();
//            $table->string('use_case_invited_vendors')->nullable()->default(null)->change();
//        });
//
//        Schema::create('use_case', function (Blueprint $table) {
//            $table->id();
