                ...
                datasets: [
                    {
                        ...
                        data: [
                            @foreach($practices as $practice)
                                "{{$practice->averageReleasedApplicationsInOldProjectsWithThisPractice($regionsToFilter,$yearsToFilter)}}",
                            @endforeach
                        ]
                    }
                ]
                ...
                datasets: [
                    {
                        ...
                        data: [
                            @foreach($practices as $practice)
                                "{{$practice->projectsFilteredToBenchmarkOverview($regionsToFilter,$yearsToFilter)}}",
                            @endforeach
                        ]
                    }
                ]
                ...
                datasets: [
                    {
                        ...
                        data: [
                            @foreach($clients as $client)
                                "{{$client->projectsClientFilteredBenchmarkOverview($regionsToFilter,$yearsToFilter)}}",
                            @endforeach
                        ]
                    }
                ]
