                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div id="charts-container" class="col-8 border-left">
                                    <div class="row pl-3">
                                        <h3>Innovation and Vision Results</h3>
                                    ...
                                    <div class="row" id="chart1-row">
                                        <div class="col-xl-12 grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4>Best {{count($vendorScoresInnovation)}} Vendors By Innovation and Vision Score</h4>
                                                    <br><br>
                                    ...
                                    <div class="row" id="table-projects-count-row">
                                        <div class="col-xl-12 grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h5>Number of projects of the best {{count($vendorScoresInnovation)}} vendors by Innovation and Vision score</h5>
                                                    <table class="table">
                                                        <thead>
                                                        <tr>
