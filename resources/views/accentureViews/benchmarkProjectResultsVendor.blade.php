                                ...
                                <div id="charts-container" class="col-8 border-left">
                                    ...
                                    <div class="row" id="chart1-row">
                                        <div class="col-xl-12 grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4>Best {{count($vendorScoresVendor)}} Vendors By Vendor Score</h4>
                                                    <br><br>
                                                    <canvas id="best-vendor-chart"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('#filter-btn').click(function () {
            ...
            var currentUrl = '/accenture/benchmark/projectResults/vendor';
            var url = currentUrl + '?'
                + 'practices=' + practices
        ...
        var overallChart = new Chart($('#best-vendor-chart'), {
                type: 'bar',
                data: {
                    labels: [
                        @foreach($vendorScoresVendor as $key=>$vendorScore)
