                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="welcome_text extra-top-15px">
                                    Provide orals location and dates, and select vendors to be invited to the orals
                                    session.
                                ...
                                <div class="input-group date datepicker" id="datePicker1"
                                     data-initialvalue="{{$project->oralsFromDate}}">
                                    <input
                                        id="fromDate"
                                        type="text"
                                        class="form-control"
                                ...
                                <div class="input-group date datepicker" id="datePicker2"
                                     data-initialvalue="{{$project->oralsToDate}}">
                                    <input
                                        id="toDate"
                                        type="text"
                                        class="form-control"
...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.invitedToOrals').change(function (e) {
            ...
            $('.oralsCompleted').change(function (e) {
