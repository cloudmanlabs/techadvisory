                            ...
                            <div class="card-body">
                                ...
                                <div id="wizard_accenture">
                                    ...
                                    <section>
                                        ...
                                        <h4>Questions</h4>
                                        <br>
                                        <x-questionForeachWithEvaluate :questions="$fitgapQuestions"
                                                                       :class="'selectionCriteriaQuestion'"
                                                                       :disabled="true" :evalDisabled="true"
                                                                       :required="false"/>
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        @else
                                            <x-selectionCriteria.nonBindingImplementation
                                                :vendorApplication="$vendorApplication" :disabled="true"
                                                :evaluate="true" :evalDisabled="true"/>
                                        @endif

                                        <br>
                                        <h4>Run</h4>
                                        <x-selectionCriteria.pricingModel :vendorApplication="$vendorApplication"
                                                                          :disabled="true" :evaluate="false"/>
