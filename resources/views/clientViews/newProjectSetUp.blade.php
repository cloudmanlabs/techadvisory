...
@section('content')
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
                                ...
                                <div id="wizard_client_newProjectSetUp">
                                    ...
                                    <section>
                                        ...
                                        <x-folderFileUploader :folder="$project->rfpFolder" label="Upload your RFP"
                                                              :timeout="1000"
                                                              :disabled="$project->step4SubmittedClient"/>
                                    ...
                                    <section>
                                        <p class="welcome_text extra-top-15px">
                                            Input all required project information that vendors will use to perform the
                                            sizing of their proposals.
                                        </p>
                                        <br>
                                    ...
                                    <section>
                                        ...
                                        <div id="subwizard_here">
                                            ...
                                            <div>
                                                <h4>4.1. Fit Gap</h4>
                                                <p class="welcome_text extra-top-15px">
                                                    This section includes all your functional, technical and service
                                                    requirements, among others.
                                                </p>
                                                <br>
                                                <p>
                                                    Click Review Fit Gap Table to see all requirements gathered and
                                                    logged by Accenture.
                                                    Review the requirements and contact Accenture in case anything is
                                                    not accurate, and
                                                    provide or adjust requirement importance by filling in the Client
                                                    Score.
                                                </p>
                                                <br>
                                                ...
                                                <br><br>
                                                <p class="welcome_text extra-top-15px">
                                                    Below is the questionnaire designed to know more about the vendor’s
                                                    previous experiences with other clients and within the industry.
                                                </p>
                                                <br>
                                                <h4>Questions</h4>
                                                <br>
            ...
            <div class="modal fade" id="step4SubmitModal" tabindex="-1" role="dialog"
