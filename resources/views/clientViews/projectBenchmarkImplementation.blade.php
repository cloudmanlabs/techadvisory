                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="welcome_text extra-top-15px">
                                    {{nova_get_setting('client_projectBenchmarkImplementation_ranking') ?? ''}}
                                </p>
                                <br>
                                <br>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="welcome_text extra-top-15px">
                                    {{nova_get_setting('client_projectBenchmarkImplementation_comparison') ?? ''}}
                                </p>
                                <br>
                                <br>
                                <div class="row">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        <thead>
                                                            <tr class="table-dark">
                                                                <th>Cost</th>
                                                                @foreach ($applications as $application) <th class="filterByVendor"
                                                                    data-vendor="{{$application->vendor->name}}">{{$application->vendor->name}}</th>
                                                                    @endforeach
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="filterByVendor" data-vendor="{{$application->vendor->name}}">$
                                                                    {{number_format($application->implementationMoney(), 2)}}</td>
                                                                @endforeach
                                                            </tr>
                                                            <tr>
                                                                <th class="table-dark">Average Yearly Run</th>
                                                                @foreach ($applications as $application)
                                                                <td class="filterByVendor" data-vendor="{{$application->vendor->name}}">$ {{number_format($application->runMoney(), 2)}}
                                                                </td>
                                                                @endforeach
                                                            </tr>
                                                        </tbody>
