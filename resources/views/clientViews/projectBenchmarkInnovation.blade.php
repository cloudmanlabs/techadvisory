    ...
    <x-client.navbar activeSection="sections" />
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <x-client.projectNavbar section="projectBenchmark" subsection="innovation" :project="$project" />
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="welcome_text extra-top-15px">
                                    {{nova_get_setting('client_projectBenchmarkInnovation_ranking') ?? ''}}
                                </p>
                                <br>
                                <br>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="welcome_text extra-top-15px">
                                    {{nova_get_setting('client_projectBenchmarkInnovation_comparison') ?? ''}}
                                </p>
                                <br>
                                <br>
                                <div class="row">
