    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <x-client.projectNavbar section="projectBenchmark" subsection="innovation" />
                ...
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h3>Overall Vendor Ranking by Innovation & Vision</h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4>VENDORS SORTED BY EXPERIENCE IN THE MARKET</h4>
                                                <br>
