            ...
            <div class="profile-header">
                <div class="header-links">
                    <ul class="links d-flex align-items-center mt-3 mt-md-0">
                        ...
                        @endif
                        @if (($project->useCases === 'yes_prep' || ($project->useCases === 'yes_open' && $project->currentPhase !== 'preparation')) && $section !== 'projectEditView')
                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center {{$section == 'useCasesSetUp' ? 'active' : ''}}">
                            ...
                            <a class="pt-1px d-none d-md-block" href="{{route('accenture.projectUseCasesSetUp', ['project' => $project])}}">{{$project->useCasesPhase === 'evaluation' ? 'Use Cases' : 'Use Cases Set Up'}}</a>
                        </li>
                        @endif
                        @if ($section === 'projectEditView')
                            <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center {{$section == 'useCasesSetUp' ? 'active' : ''}}"
                                id="useCaseMenuOption"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                     stroke-linejoin="round" class="feather feather-check-circle"
