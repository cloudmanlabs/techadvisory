    ...
    <nav class="navbar top-navbar">
        <div class="container">
            <div class="navbar-content">
                <a class="navbar-brand" href="{{route('client.main')}}">
                ...
                <li class="nav-item {{$activeSection == 'projects' ? 'active' : ''}}">
                    ...
                    <div class="submenu">
                        <ul class="submenu-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('client.home')}}#preparation_phase">
                                    Preparation Phase
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('client.home')}}#open_projects">
                                    Open Projects
                                </a>
                            </li>
                            <li class="nav-item">
