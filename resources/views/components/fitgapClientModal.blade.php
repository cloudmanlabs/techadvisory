        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="{{route('fitgapClientIframe', ['project' => $project, 'disabled' => $disabled, 'isAccenture' => $isAccenture ])}}"
                        style="width: 100%; min-height: 600px; border: none;"></iframe>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-lg btn-icon-text" data-toggle="modal"
                        data-target=".fitgapClientModal"><svg xmlns="http://www.w3.org/2000/svg" width="24"
