...
<div class="form-group">
    ...
    <div>
        ...
        <div style="display: flex; flex-direction: row">
            <input type="number" id="averageYearlyCostMin" class="form-control nonBindingInput" placeholder="Min"
                   data-changing="averageYearlyCostMin"
                   value="{{$vendorApplication->averageYearlyCostMin}}"
                   {{$disabled ? 'disabled' : ''}} min="0" required>
            <input style="margin-left: 1rem;" id="averageYearlyCostMax" type="number"
                   class="form-control nonBindingInput" placeholder="Max" data-changing="averageYearlyCostMax"
...
<br>
<p>Average Yearly Cost: {{$vendorApplication->project->currency ?? ''}} <span id="averageEstimate5YearsCost">0</span>
</p>
