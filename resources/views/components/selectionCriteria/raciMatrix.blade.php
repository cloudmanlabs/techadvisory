            ...
            <div>
                ...
                <div style="display: flex; flex-direction: row">
                    <input type="text" class="form-control raciTitleInput" placeholder="Title"
                           value="{{$row['title'] ?? ''}}"
                        {{$disabled ? 'disabled' : ''}}>
                    <select class="form-control raciClientInput"
                            style="margin-left: 1rem" {{$disabled ? 'disabled' : ''}}>
                        <option disabled>Please choose one</option>
                        <option {{$row['client'] == "Responsible" ? 'selected' : ''}} value="Responsible">Responsible
                        </option>
                        <option {{$row['client'] == "Accountable" ? 'selected' : ''}} value="Accountable">Accountable
                        </option>
                    ...
                    <select class="form-control raciVendorInput"
                            style="margin-left: 1rem" {{$disabled ? 'disabled' : ''}}>
                        <option disabled>Please choose one</option>
                        <option {{$row['vendor'] == "Responsible" ? 'selected' : ''}} value="Responsible">Responsible
                        </option>
                        <option {{$row['vendor'] == "Accountable" ? 'selected' : ''}} value="Accountable">Accountable
                        </option>
                    ...
                    <select class="form-control raciAccentureInput"
                            style="margin-left: 1rem" {{$disabled ? 'disabled' : ''}}>
                        <option disabled>Please choose one</option>
                        <option {{$row['accenture'] == "Responsible" ? 'selected' : ''}} value="Responsible">
                            Responsible
                        </option>
                        <option {{$row['accenture'] == "Accountable" ? 'selected' : ''}} value="Accountable">
                            Accountable
                        </option>
                        <option {{$row['accenture'] == "Consulted" ? 'selected' : ''}} value="Consulted">Consulted
                        </option>
