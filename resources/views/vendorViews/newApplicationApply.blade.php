    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <x-video :src="nova_get_setting('video_application_file')"
                         :text="nova_get_setting('video_application_text')"/>
                                ...
                                <div id="wizard_vendor_go_to_home">
                                    ...
                                    <section>
                                        <p class="welcome_text extra-top-15px" style="color:red">
                                            In order to complete FitGap Table, please bear in mind that only one user
                                            must work on it simultaneously using one
                                            single browser tab to avoid loss of data because of conflicting inputs when
                                            saving.
                                        </p>
                                        <p class="welcome_text extra-top-15px">
                                            Provide your inputs on how your solution/s will cover the client’s
                                            functional, technical and service requirements, among others.
                                        </p>
                                        <p class="welcome_text extra-top-15px">
                                            Click Review Fit Gap Table to see all client requirements. Select the most
                                            suitable answer under the Vendor Score column and provide additional
                                            information or highlights in the Comments column.
                                        </p>
                                        <br><br>
                                    ...
                                    <section>
                                        ...
                                        <br>
                                        <x-questionForeach :questions="$vendorCorporateQuestions"
                                        ...
                                        <p class="welcome_text extra-top-15px">
                                            Below is the questionnaire designed to know more about your presence in the
                                            market.
                                        </p>
                                        <br>
                                    ...
                                    <section>
                                        <p class="welcome_text extra-top-15px">
                                            Inform us about your previous experiences in the industry and with other
                                            clients.
                                        </p>
                                        <br>
                                        <h4>Questions</h4>
                                        <p class="welcome_text extra-top-15px">
                                            Below is the questionnaire designed to know more about previous experiences
                                            with other clients and within the industry.
                                        </p>
                                        <br>
                                    ...
                                    <section>
                                        <p class="welcome_text extra-top-15px">
                                            Tell us about the IT enablers used by your solution/s, alliances in place,
                                            product insights and sustainability guidelines followed.
                                        </p>
                                        <br>
                                        <h4>IT Enablers</h4>
                                        <p class="welcome_text extra-top-15px">
                                            Below is the questionnaire designed to know more about the IT Enablers
                                            currently used by your solution/s.
                                        </p>
                                        <br>
                                        ...
                                        <h4>Alliances</h4>
                                        <p class="welcome_text extra-top-15px">
                                            Below is the questionnaire designed to know more about the alliances you
                                            have with other solution providers.
                                        </p>
                                        <br>
                                        ...
                                        <h4>Product</h4>
                                        <p class="welcome_text extra-top-15px">
                                            Below is the questionnaire designed to get more insights about your
                                            products.
                                        </p>
                                        <br>
                                        ...
                                        <p class="welcome_text extra-top-15px">
                                            Below is the questionnaire designed to know more about your sustainability
                                            guidelines.
                                        </p>
                                        <br>
                                    ...
                                    <section>
                                        @if ($project->id == 139)
                                            <p class="welcome_text extra-top-15px" style="color:red">
                                                This section covered as part of RFP response document. To complete
                                                questionnaire please only fill "Solutions used" with
                                                the solutions you are offering, and implementation & run costs with a
                                                "0". Finally, click on Submit to send your
                                                application.
                                            </p>
                                        @endif
                                        @if ($project->id == 140)
                                        ...
                                        @endif
                                        <p class="welcome_text extra-top-15px">
                                            Let us know more about the project plan, main deliverables and RACI you
                                            proposed. Provide a cost estimation for both implementation and run phases.
                                        </p>
                                        <br>

                                        <h4>Implementation</h4>
                                        <p class="welcome_text extra-top-15px">
                                            Use the following section to provide all details regarding the
                                        ...
                                        <x-selectionCriteria.solutionsUsed :vendorApplication="$vendorApplication"
                                                                           :disabled="false"/>
                                        ...
                                        @if ($project->isBinding)
                                            ...
                                            <p>
                                                ...
                                                <span id="overallImplementationCost">0</span>
                                                {{$vendorApplication->project->currency ?? ''}}
                                            </p>
                                        @else
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        Are you sure you want to submit your project application? Be
                                                        aware that no further modifications will be allowed on your
                                                        answers once project application is submitted.
                                                    </div>
