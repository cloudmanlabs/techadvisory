                            ...
                            <div class="card-body">
                                ...
                                <div id="wizard_vendor_go_to_home">
                                    ...
                                    <section>
                                        ...
                                        <x-folderFileUploader :folder="$vendorApplication->corporateFolder"
                                                              :timeout="1000"/>
                                    ...
                                    <section>
                                        ...
                                        <x-folderFileUploader :folder="$vendorApplication->experienceFolder"
                                                              :timeout="1000"/>
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        @if ($project->isBinding)
                                            ...
                                            <p>Overall Implementation Cost: <span
                                                    id="overallImplementationCost">0</span> {{$vendorApplication->project->currency ?? ''}}
                                            </p>
                                        @else
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        ...
                                                        aware
                                                        that no further modifications will be allowed on your answers
                                                        once project application is submitted.
                                                    </div>
