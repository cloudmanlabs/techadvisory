                            ...
                            <div class="card-body">
                                ...
                                <div id="wizard_vendor_go_to_home">
                                    ...
                                    <section>
                                        ...
                                        <h4>Questions</h4>
                                        <br>
                                        <x-questionForeach :questions="$fitgapQuestions" :class="'fitgapQuestions'" :disabled="false"
                                            :required="false" />
                                    </section>
                                    ...
                                    <section>
                                        ...
                                        <br>
                                        <x-questionForeach :questions="$vendorCorporateQuestions" :class="'vendorCorporateQuestions'" :disabled="false" :required="false" />

                                        <br><br>
                                        <h4>Market presence</h4>
                                        <x-questionForeach :questions="$vendorMarketQuestions" :class="'vendorMarketQuestions'" :disabled="false" :required="false" />
                                    </section>
                                    ...
                                    <section>
                                        <h4>Questions</h4>
                                        <br>
                                        <x-questionForeach :questions="$experienceQuestions" :class="'experienceQuestions'" :disabled="false"
                                            :required="false" />
                                    </section>
                                    ...
                                    <section>
                                        <h4>IT Enablers</h4>
                                        <br>
                                        <x-questionForeach :questions="$innovationDigitalEnablersQuestions" :class="'innovationDigitalEnablersQuestions'" :disabled="false" :required="false" />

                                        <h4>Alliances</h4>
                                        <br>
                                        <x-questionForeach :questions="$innovationAlliancesQuestions" :class="'innovationAlliancesQuestions'" :disabled="false" :required="false" />

                                        <h4>Product</h4>
                                        <br>
                                        <x-questionForeach :questions="$innovationProductQuestions" :class="'innovationProductQuestions'" :disabled="false" :required="false" />

                                        <h4>Sustainability</h4>
                                        <br>
                                        <x-questionForeach :questions="$innovationSustainabilityQuestions" :class="'innovationSustainabilityQuestions'" :disabled="false" :required="false" />
                                    </section>
