        ...
        Route::middleware(['auth', 'checkClient'])->group(function () {
            ...
            Route::middleware(['checkUserHasFinishedSetup'])->group(function(){
                ...
                Route::middleware(['checkClientOwnsProject'])->group(function () {
                    ...
                    Route::post('/newProjectSetUp/setStep3Submitted', 'ProjectController@setStep3Submitted');       // feature 2.8
                    Route::post('/newProjectSetUp/setStep3Rollback', 'ProjectController@setStep3Rollback');
