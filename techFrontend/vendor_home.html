				...
				<nav class="navbar top-navbar">
					<div class="container">
						<div class="navbar-content">
							<a class="navbar-brand" href="./vendor_home.html"><img src="./assets/images/techadvisory-logo.png" style="max-height: 37px;"></a>
									...
									<div aria-labelledby="profileDropdown" class="dropdown-menu">
										<div class="dropdown-header d-flex flex-column align-items-center">
											<div class="info text-center">
												<p class="name font-weight-bold mb-0">Vendor Name</p>
											</div>
										</div>
										<div class="dropdown-body">
											<ul class="profile-nav p-0 pt-3">
												<li class="nav-item">
													<a class="nav-link" href="./login_vendor.html"><i data-feather="log-out"></i> <span>Log Out</span></a>
												</li>
											</ul>
										</div>
									</div>
				...
				<nav class="bottom-navbar">
					<div class="container">
						<ul class="nav page-navigation">
							<li class="nav-item">
								<a class="nav-link" href="vendor_home.html">
							...
							<li class="nav-item">
								...
								<div class="submenu">
									<ul class="submenu-item">
										...
										<li class="nav-item"><a class="nav-link" href="./vendor_home.html#invitation_phase">Invitation Phase</a></li>
										<li class="nav-item"><a class="nav-link" href="./vendor_home.html#open_projects">Open Projects</a></li>
										<li class="nav-item"><a class="nav-link" href="./vendor_home.html#closed_projects">Closed Projects</a></li>
							...
							<li class="nav-item">
								...
								<div class="submenu">
									<ul class="submenu-item">
										...
										<li class="nav-item"><a class="nav-link" href="vendor_solutions_home.html">View solutions</a></li>
										<li class="nav-item"><a class="nav-link" href="vendor_new_solution_set_up.html">Add new solution</a></li>
									</ul>
								</div>
							</li>
									...
									<div class="card" style="margin-bottom: 30px;">
										<div class="card-body">
											...
											<div style="float: right; text-align: right; width: 17%;">
												<a class="btn btn-primary btn-lg btn-icon-text" href="vendor_new_application.html">Apply <i class="btn-icon-prepend" data-feather="arrow-right"></i></a>
											</div>
