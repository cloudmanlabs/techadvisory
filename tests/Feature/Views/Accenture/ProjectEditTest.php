...
class ProjectEditTest extends TestCase
{
    ...
    public function testAccentureProjectEditWithoutProject()
    {
        $user = factory(User::class)->states('accenture')->create();

        $response = $this
            ->actingAs($user)
            ->get('/accenture/project/edit');

        $response->assertStatus(404);
    }

    public function testAccentureProjectEditWithProject()
    {
        $user = factory(User::class)->states('accenture')->create();
        ...
        $response = $this
            ->actingAs($user)
            ->get('/accenture/project/edit/' . $project->id);
