...
class ProjectVendorProposalEdit extends TestCase
{
    use RefreshDatabase;
    ...
    public function testWithoutProject()
    {
        ...
        $response = $this
            ->actingAs($user)
            ->get('/accenture/project/vendorProposal/edit');
    ...
    public function testWithProjectAppliedTo()
    {
        ...
        $response = $this
            ->actingAs($user)
            ->get('/accenture/project/vendorProposal/edit/' . $project->id . '/'. $vendor->id);
